...
class App extends React.Component{
  ...
  CountItems = () => {
    ...
    let count = 0;
//loop through the products and finnd all their total quantity
  ...
  getCost = () => {
    let cost = 0.0;
    const { products } = this.state;//get the products from state 

    //lop through all products 
    products.forEach((product) => {
